...
class OnyxSocialLivePost(models.Model):
    ...
    _name = 'onyx.social.live.post'
    _description = 'Social Live Post'

    post_id = fields.Many2one('onyx.social.post', string="Social Post", required=True, readonly=True, ondelete="cascade")
    account_id = fields.Many2one('onyx.social.account', string="Social Account", required=True, readonly=True, ondelete="cascade")

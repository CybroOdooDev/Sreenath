...
class PurchaseOrderWhatsapp(models.Model):
    _inherit = 'purchase.order'

    def purchase_order_whatsapp(self):
        '''
        This module helps to send whatsapp message to the customer from the purchase order.
        ...
        if not self.partner_id.mobile[0] == "+":
            ...
            return {'type': 'ir.actions.act_window',
                    ...
                    'view_type': 'form',
                    'context': {
                        'default_mail_template_id': self.env.ref('whatsapp_integration_odoo.whatsapp_template_for_purchase_order').id},
                    }
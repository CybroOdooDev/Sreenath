...
class DHLParcel(models.Model):
    ...
    ccustom_pdf = fields.Many2many('ir.attachment', 'ccustom_pdf_ir_attachments_rel',
                                'dhl_parcel_id', 'attachment_id', string='Attachments', store=True)
    ...
    def _compute_tracking_url(self):
        for rec in self:
            ...
            rec.tracking_url = "https://www.dhl.com/" + country_code + "-" + language.url_code + "/home/tracking/tracking-global-forwarding.html?submit=1&tracking-id=" + str(self.tracking_url)

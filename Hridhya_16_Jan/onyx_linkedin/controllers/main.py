...
class SocialLinkedinOnyxPost(http.Controller):
    ...
    def social_linkedin_post(self, value):
        print('kkkkkkkkkkkkkkkkkkkkkkkkkkjhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh',value.get('client_id'))
        ...
        access_token_linkedin = request.env['onyx.social.account'].search([('onyx_media_type', '=', 'linkedin'),('client_id', '=', client_id)]).linkedin_accesstoken
        if access_token_linkedin:
            ...
            print('linkedin_imagelinkedin_imagelinkedin_image', linkedin_image)
            ...
            if user_name not in account.mapped('name'):
                ...
                social_account = request.env['onyx.social.account'].create({
                    ...
                    'image': media.image,
                    'linkedin_accesstoken': access_token_linkedin
                })
    ...
    def social_linkedin_callbacks(self, httpReq=None):
        ...
        if user_name not in account.mapped('name'):
            ...
            social_account = request.env['onyx.social.account'].create({
                ...
                'client_id': request.uid,
                'image': media.image,
                'linkedin_accesstoken': access_token
            })
...
#                         "thumbnails": [
#                             {
#                                 "resolvedUrl": str(linkedin_image)
#                             },
#                         ]
#                     }
#                 ],

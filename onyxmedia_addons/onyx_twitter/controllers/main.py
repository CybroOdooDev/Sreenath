...
class SocialTwitterOnyx(http.Controller):
    ...
    def social_twitter_callbacks(self):
        ...
        print(twitter_consumer_key,'sssssssssssssssssssssssssss',twitter_consumer_secret_key)
        ...
        # # Upload image
        status = "Flower floswerss"
        api.update_status(status=status)
        # media = api.media_upload("/home/cybrosys/Pictures/Screenshot from 2022-08-22 15-57-29.png")
        print(api, 'dgddddddd')
        media = api.media_upload("/home/cybrosys/Downloads/pexels-pixabay-60597.jpg")

odoo.define('dr_social_website.portal', function (require) {
"use strict";
console.log('jdddddddddddddddddddddddddd')
var core = require('web.core');
var SocialLinkDialog = require('dr_social_website.link.dialog');
